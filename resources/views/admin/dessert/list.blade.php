...
@section('content')
    <div class="x_panel">
        <div class="pull-right">
            <h2></h2>
            <div class="right">
                <a href="{{route('dessert.create')}}" class="btn btn-success btn-icon icon-left" id="add-note">
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered table-responsive">
                ...
                @foreach($desserts as $dessert)
                    <tr>
                        ...
                        <td><a href="{{route('dessert.edit', $dessert->id)}}"
                               class="btn btn-info btn-sm">
                                <i class="fa fa-edit"></i>
                                Düzenle</a>
                            <a href="{{route('dessert.destroy', $dessert->id)}}"
                               class="btn btn-danger btn-sm destroyButton" data-destroypersonal="{{$dessert->name}}">
